...
$_['text_payment_network'] = '<img src="view/image/payment/payment_network.jpg" alt="Payment Network" title="Payment Network" style="border: 1px solid #EEEEEE;" />';
...
$_['text_gateway_url']     = "Enter the Gateway Url";
...
$_['entry_order_status_success'] = 'Order Status Success:';
...
$_['error_msg_gateway_url'] = 'Gateway Url Required!';
...
// module type switch information
$_['entry_customer_wallets']         = 'Customer Wallets';
$_['entry_customer_wallets_enabled']  = 'Enabled';
$_['entry_customer_wallets_disabled']  = 'Disabled';
